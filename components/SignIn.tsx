    ...
    import { View, Text, TextInput, TouchableOpacity, ActivityIndicator, Touchable  } from "react-native";
        ...
        return (
            <View style={{ flex: 1, justifyContent: "center", padding: 20 }}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("ForgotPassword")}>
                    <Text style={{ textAlign: "center", marginTop: 2, marginBottom: 15, fontWeight: 600, color: "blue" }}> Forgot Password? {""} </Text>
                </TouchableOpacity>
